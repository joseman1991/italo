...
if (isset($_POST['btn-update'])) {
    ...
    if ($crud->update($id, $fname, $lname, $email, $contact, $pais)) {
        ...
        <table class='table table-bordered'>
            ...
            <tr>
                ...
                <td> 
                    ...
                    <select class='form-control' required name='pais_codigo'> 
<?php
...
while ($row = $data->fetch(PDO::FETCH_ASSOC)) {
    ...
    if ($idpais == $row['codigo']) {
        echo '<option value="' . $row['codigo'] . '" selected>' . $row['nombre'] . '</option>'; // POSICIONA EN LA FILA 
    } else {
