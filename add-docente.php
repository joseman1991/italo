...
if (isset($_POST['btn-save'])) {
    ...
    $nac = $_POST['nac'];
    $tit = $_POST['ti'];
    if ($crud->insertarDocente($dni, $lnombre1, $nombre2, $apellido1, $apellido2, $tel, $mail, $nac, $tit)) {
        header("Location: add-docente.php?inserted");
    } else {
        echo $crud->error;
        header("Location: add-docente.php?failure");
    }
}
?>
...
if (isset($_GET['inserted'])) {
    ...
    <div class="container">
        <div class="alert alert-info">
            <strong>WOW!</strong> Record was inserted successfully <a href="index.php">Inicio</a>!
        </div>
    </div>
    <?php
...
<div class="container">
    <form method='post'>
        <table class='table table-bordered'>
            ...
            <tr>
                <td>Titulo</td>
                <td><input type='text' name='ti' class='form-control' required></td>
            </tr>
            <tr>
                <td>Nacionalidad</td>
                <td>
